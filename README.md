...
빅데이터 처리 과정에서 분석/설계/인력 등 큰 비용이 발생하기 때문에 소규모의 회사에서는 자사의DB시스템을 구축하거나 EMR서비스를 사용하기 부담스러운 문제가 있다.<br>
해당 프로젝트의 빅데이터 프레임워크를 통해서 중소,스타트업의 빅데이터 구축 시 발생하는 비용 문제를 해결할 수 있을 것으로 기대된다. 
